...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-[95vh] flex items-center bg-sky-50/30 dark:bg-neutral-950 pt-20 overflow-hidden">
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-xl mb-10 leading-relaxed font-medium">
            {t('hero.description')}
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <Button asChild variant="outline" size="lg" className="rounded-full px-8 border-2 border-sky-200 text-sky-700">
        ...
        <div className="relative hidden lg:block w-full h-[550px]">
          <AnimatePresence mode="wait">
            <motion.div 
              ...
              className="absolute inset-0 rounded-[2.5rem] overflow-hidden shadow-2xl border-[12px] border-white dark:border-neutral-900"
            >
              <Image src={slides[current].img} alt="Sofi Banner" fill className="object-cover" />
            </motion.div>
          </AnimatePresence>
        </div>
      </div>
